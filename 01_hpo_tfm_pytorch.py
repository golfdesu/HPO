...
if __name__ == '__main__':
    print("=" * 65)
    print("🚀 Baseline Vanilla Transformer Encoder PyTorch FULL HPO")
    print("=" * 65)
    ...
    study = optuna.create_study(
        ...
        direction="minimize",
        study_name="01_hpo_tfm_pytorch_full"
    )
    ...
    output_json = "01_hpo_tfm_pytorch_best_params.json"
